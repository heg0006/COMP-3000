...
int a = 0;
	...
	cout << "Aaron won " << aaron_wins << "/" << runs << " duels or " << strategy1 << "%" << endl;
...
void _two_alive(void){
	...
	assert(false == two_alive(false, false, true));
	cout << "Case passed ..." << endl;
	cout << "Case 6: Aaron dead, Bob alive, Charlie dead" << endl;
	assert(false == two_alive(false, true, false));
	cout << "Case passed ..." << endl;
	cout << "Case 7: Aaron alive, Bob dead, Charlie dead" << endl;
	assert(false == two_alive(true, false, false));
	cout << "Case passed ..." << endl;
	cout << "Case 8: Aaron dead, Bob dead, Charlie dead" << endl;
	assert(false == two_alive(false, false, false));
	cout << "Case passed ..." << endl;
press_key();
return;
}
...
//Determining if Aaron's first shot is a hit 
void first_aaron(bool& Bob_alive, bool& Charlie_alive){
	if(Charlie_alive)
...
//Determining if Bob's shot is a hit
void bob_shot(bool& Aaron_alive, bool& Charlie_alive){
	if(Charlie_alive)
...
//Determining if Charlie's shot is a hit
void charlie_shot(bool& Aaron_alive, bool& Bob_alive){
	if(Bob_alive)
		Bob_alive = false;
	else
...
//Determining if Aaron's second shot is a hit
void second_aaron(bool& Bob_alive, bool& Charlie_alive){
